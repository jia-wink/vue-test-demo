 ...
 * @Date: 2023-04-13 09:44:19
 * @LastEditTime: 2023-04-27 16:36:22
 * @LastEditors: jia-wink 1847949884@qq.com
 * @Description: 常用的工具类
 * @FilePath: \vue-test-demo\src\utils\utils.ts
 *
 ...
 * @param {1 | 2} type 1 使用表时间戳，在时间段开始的时候触发 2 使用表定时器，在时间段结束的时候触发
 * @return {*}
 */
export const throttle: (func: Function, wait: number, type: 1 | 2) => Function = (
  func: Function,
  wait: number = 500,
  type: 1 | 2 = 1
): Function => {
